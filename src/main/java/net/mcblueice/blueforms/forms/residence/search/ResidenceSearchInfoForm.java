...
public class ResidenceSearchInfoForm {
    ...
    public ResidenceSearchInfoForm(Player player, ConfigManager lang) {
        this.player = player;
        this.lang = lang;
    }
    ...
    public void open() {
        ...
        if (hasCurrentResidence) residenceList.add(lang.get("forms.residence.search.info.current", currentResidence));
        residenceList.add(lang.get("forms.residence.search.info.manual"));
        residenceList.addAll(ResidenceUtils.getPlayerResListNames(player));

        CustomForm.Builder builder = CustomForm.builder()
            .title(lang.get("forms.residence.search.info.title"))
            .dropdown(lang.get("forms.residence.search.info.dropdown"), residenceList)
            .input(lang.get("forms.residence.search.info.input1"), lang.get("forms.residence.search.info.input2"));
