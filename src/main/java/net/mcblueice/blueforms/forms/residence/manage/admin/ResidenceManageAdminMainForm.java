...
public class ResidenceManageAdminMainForm {
    private final Player player;
    private final ConfigManager lang;
    private final ClaimedResidence claimedResidence;

    public ResidenceManageAdminMainForm(Player player, ConfigManager lang, ClaimedResidence claimedResidence) {
        this.player = player;
        this.lang = lang;
    ...
    public void open() {
        ...
        SimpleForm.Builder builder = SimpleForm.builder()
            .title(lang.get("forms.residence.manage.admin.main.title"))
            .content(generateContent());

        List<String> buttonKeys = new ArrayList<>(lang.getSectionKeys("forms.residence.manage.admin.main.buttons"));
        for (String key : buttonKeys) {
            String name = lang.get("forms.residence.manage.admin.main.buttons." + key + ".name");
            String icon = lang.get("forms.residence.manage.admin.main.buttons." + key + ".icon");
        ...
        builder.validResultHandler((form, response) -> {
            ...
            switch (key) {
                case "rename":
                    new ResidenceManageAdminRenameForm(player, lang, claimedResidence).open();
                    break;
                case "expand":
                    new ResidenceManageAdminExpandForm(player, lang, claimedResidence).open();
                    break;
                case "give":
                    new ResidenceManageAdminGiveForm(player, lang, claimedResidence).open();
                    break;
                case "remove":
    ...
    private String generateContent() {
        ...
        return lang.get("forms.residence.manage.admin.main.content.template",
            name,
            createDate,
            owner,
            adminList,
